...
//
//?>
<!--<h2 align=center>다크웹 크롤링 테스트</h2>-->
<!--<table align = center>-->
<!--    <thead align = "center">-->
<!--    <tr>-->
<!--        <td width = "50" align="center">No</td>-->
<!--        <td width = "200" align = "center">TITLE</td>-->
<!--        <td width = "200" align = "center">DATA</td>-->
...
//            ?><!--                      <tr>-->
<!--        --><?php //} ?>
<!--        <td width=50 align="center" style="word-break:break-all">--><?php //echo $rows['NO']?><!--</td>-->
<!--        <td width=400 align="center" style="word-break:break-all">--><?php //echo $rows['title']?><!--</td>-->
<!--        <td width=400 align="center" style="word-break:break-all">--><?php //echo $rows['album']?><!--</td>-->
<!--        <td width=400 align="center" style="word-break:break-all"><a href = "--><?php //echo $rows['url']?><!--">--><?php //echo $rows['url']?><!--</td>-->
<!--        </tr>-->
<!--        --><?php
//       $total--;
//    }
...
<table align = center>
    ...
    if($page > 1){
        $pre = $page - 1;
        echo "<a href=\"test_crawlingtest_text.php?page=$pre\">이전 </a>";
    }
    ...
    while($page_num <= $total_page){
        if($page==$page_num){
            echo "<a style=\"color:purple;\" href=\"test_crawlingtest_text.php?page=$page_num\">$page_num </a>";
        } else {
            echo "<a href=\"test_crawlingtest_text.php?page=$page_num\">$page_num </a>"; }
        $page_num++;
    }

    if($page < $total_page){
        $next = $page + 1;
        echo "<a href=\"test_crawlingtest_text.php?page=$next\">다음 </a>";
    }
    if($page < $total_page){
        echo "<a href=\"test_crawlingtest_text.php?page=$total_page\">[끝]</a>";
    }
    ?>
